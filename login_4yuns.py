...
使用方法:
    from login import login_to_4yuns
    
    # 登录并获取会话
    session, cookies = login_to_4yuns(username, password)
"""
...
def login_to_4yuns(username, password, base_url="https://shop.4yuns.com"):
    """
    登录四云发卡网
...
if __name__ == "__main__":
    ...
    try:
        session, cookies = login_to_4yuns(test_username, test_password)
        print("登录成功!")
...
def modify_goods_price(session, goods_id, new_price, goods_data, base_url="https://shop.4yuns.com"):
    """
    修改商品价格
...
def get_goods_edit_data(session, goods_id, base_url="https://shop.4yuns.com"):
    """
