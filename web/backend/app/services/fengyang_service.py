...
class FengyangService(BaseService):
    """枫阳发卡服务"""

    PLATFORM_CODE = "fengyang"
    BASE_URL = "https://faka.hbfywlkj.com"
    ...
    def get_product_price(self, product_url: str) -> dict:
        ...
        try:
            # 从URL中提取goods_key
            # URL格式: https://faka.hbfywlkj.com/item/9q72u4
    ...
    def submit_order(self, product_url: str, new_price: float) -> dict:
        ...
        try:
            ...
            # 步骤5: 跟随重定向获取支付宝网关
            self.log("=" * 80)
            self.log("【枫阳-步骤5】请求payurl获取重定向 - 请求信息")
            ...
            self.log("=" * 80)
            self.log("【枫阳-步骤5】请求payurl获取重定向 - 响应信息")
            self.log(f"响应状态码: {resp.status_code}")
            ...
            # 步骤6: 请求支付页面，获取支付宝表单
            self.log("=" * 80)
            self.log("【枫阳-步骤6】请求支付页面获取支付宝表单 - 请求信息")
            ...
            self.log("=" * 80)
            self.log("【枫阳-步骤6】请求支付页面获取支付宝表单 - 响应信息")
            self.log(f"响应状态码: {resp.status_code}")
            ...
            # 步骤7: POST到支付宝网关
            self.log("=" * 80)
            self.log("【枫阳-步骤7】POST到支付宝网关 - 请求信息")
            ...
            self.log("=" * 80)
            self.log("【枫阳-步骤7】POST到支付宝网关 - 响应信息")
            self.log(f"响应状态码: {resp.status_code}")
            self.log(f"响应头Location: {resp.headers.get('Location', '')}")
            self.log("=" * 80)
            ...
            self.log("=" * 80)
            self.log("【枫阳-步骤8】请求支付宝客户端获取最终二维码 - 请求信息")
            ...
            self.log("=" * 80)
            self.log("【枫阳-步骤8】请求支付宝客户端获取最终二维码 - 响应信息")
            self.log(f"响应状态码: {resp.status_code}")
            self.log(f"响应头Location: {resp.headers.get('Location', '')}")
            self.log("=" * 80)
    ...
    def login(self, username: str, password: str, verify_code: str = "", csrf_token: str = "") -> dict:
        ...
        try:
            ...
            self.session.cookies.set("merchant-token", token, domain="faka.hbfywlkj.com")
